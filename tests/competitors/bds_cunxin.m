function [xval, fval, exitflag, output] = bds_cunxin(fun, x0, options)
...
num_blocks = min(num_direction, num_blocks);
...
searching_set_indices = divide_searching_set(num_direction, num_blocks);
