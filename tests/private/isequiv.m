...
%
% As an example:
% options=[]; options.maxdi=20; options.nr=20; isequiv({'bds', 'bds_norma'}, options)
%
% verifies bds against newuoa_norma on problems of at most 20 variables, 20 random runs for each problem.
%
