...
%title(sprintf('Performance Profile with $\\tau=10^{%d}$ and $\\beta={%d}$', int32(log10(tau)), beta), 'interpreter', 'latex');
title(sprintf('Performance Profile with $\\tau=10^{%d}$', int32(log10(tau))), 'interpreter', 'latex');
