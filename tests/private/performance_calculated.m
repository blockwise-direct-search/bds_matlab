...
% performance: the difference between the integral of bds being tested and the default one, after
% being scaled.
...
% performance for the first solver.
for is = 1 : ns
    for i = 2 : num_points
...
performance = (performance(2) - performance(1))/perf_prof{1}(2, num_points);
