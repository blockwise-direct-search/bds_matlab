...
% We use cumsum function to get the initial index of each block, where num_directions_block(1:end-1) expresses
% the number of directions from the first block to the second last block.
